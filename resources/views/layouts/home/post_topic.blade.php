      ...
      <div class="am-g div-custom ">
            <div class="am-u-sm-12 am-u-md-9 am-u-lg-9  border-radius" >
                 <div class="div-color-white border-radius am-padding-top-sm am-text-left">
                 	  <p class="am-kai am-margin-bottom-xs am-margin-left am-padding-bottom-sm">{{ trans('bbs.Welcome Post!') }}
                 	    <span class="am-text-muted am-text-sm">{{ trans('bbs.Encourage Post') }}</span>
                 	  </p>
                 </div>
                 ...
                 <p class="am-kai am-text-danger">{{ trans('bbs.Image Tips') }}</p>
					  </div>
                 </div>
                 <div class="div-color-white am-margin-top-sm border-radius am-text-left am-padding-bottom">
                 	<form class="am-form" method="post" action="{{ action('Home\TopicController@create') }}">
                      ...
                      <button class="am-btn am-btn-secondary border-radius am-margin-left am-kai">{{ trans('bbs.post') }}</button>
                       <a class="am-btn am-text-muted border-radius am-margin-left am-kai am-text-sm" data-am-modal="{target: '#doc-modal-1',width: '600',height:'249'}">{{ trans('bbs.Add Image') }}</a>
                    </form>
                 </div>
