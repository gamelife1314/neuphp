        	   ...
        	   <div class="am-panel am-panel-default community-panel am-margin-top">
          	     <div class="am-panel-hd"> <p class="am-panel-title am-kai">{{ trans('bbs.friendly community') }}</p></div>
          	      <div class="am-panel-bd">
            	        <a href="http://cnodejs.org/" target="_blank" title="cnodejs"><img src="{{ asset('image/flag/cnodejs.png') }}" alt="cnodejs" class="site-img am-img-thumbnail am-margin-top-sm border-radius"></a>
            	        <a href="http://elixir-cn.com/" target="_blank" title="ElixirChina"><img src="{{ asset('image/flag/Elixircn.png') }}" alt="ElixirChina" class="site-img am-img-thumbnail am-margin-top-sm border-radius"></a>
            	        <a href="http://golangtc.com/" target="_blank" title="GolangChina"><img src="{{ asset('image/flag/Golangcn.png') }}" alt="GolangChina" class="site-img am-img-thumbnail am-margin-top-sm border-radius"></a>
            	        <a href="https://ruby-china.org" target="_blank" title="RubyChina"><img src="{{ asset('image/flag/Rubycn.png') }}" alt="RubyChina" class="site-img am-img-thumbnail am-margin-top-sm border-radius"></a>
                      <a href="https://phphub.org/" target="_blank" title="PHPHub"><img src="{{ asset('image/flag/phphub.png') }}" alt="PHPHub" class="site-img am-img-thumbnail am-margin-top-sm border-radius"></a>
          	      </div>
        	   </div>
             <div class="am-panel am-panel-default community-panel am-margin-top">
             ...
             <div class="am-panel am-panel-default community-panel am-margin-top">
                ...
                <div class="am-panel-bd am-text-left">
                    <ul class="am-list am-list-static">
                    	...
                    	<li class="am-text-truncate"><a href="{{ route('read.topic',$value->id) }}" class="am-text-muted am-text-sm">{{ $value->title }}</a></li>
                    	@endforeach
                    </ul>
                </div>
            </div>
