<div class="am-g div-custom div-author am-margin-bottom-lg am-padding-bottom">
  	<div class="am-u-sm-12 am-u-md-12 am-u-lg-12 ">
  		<span class="am-icon-cloud am-text-xs am-fl am-padding-horizontal-xs">&nbsp;&nbsp;Made With Love By gamelife </span>
  		<span class="am-icon-user am-text-xs am-fr am-padding-right-xs">&nbsp;&nbsp;Powered By <a href="/about">gamelife</a></span>
  	</div>
